...
MSORTED_TESTS=[
    ...
    ( (0,2,1,5,3,4), [(COL_GRADE, {'reverse': False, 'clean': clean_grade}) , (COL_ATTEND, {'reverse': True})]),
    ( (3,1,5,0,2,4), [(COL_GRADE, {'reverse': True , 'clean': clean_grade}) , (COL_ATTEND, {'reverse': True})]),
    ( (3,5,1,2,0,4), [(COL_GRADE, {'reverse': True , 'clean': clean_grade}) , (COL_ATTEND, {'reverse': False})]),
    ...
    def _run_tests(self, rows_as, row_as, rows_in):
        ...
        for i, (expected, spec) in enumerate(MSORTED_TESTS):
            for j in range(0,1):
                ...
                rows_sorted = msorted(rows_in, spec, reverse=reverse)
                ...
                _dump = dump_sort(i, spec, rows_sorted, rows_as, row_as, expected)
...
def dump_sort(stest_no, spec, rows, rows_as, row_as, expected):
